...
const dictionaryPhonetics = [
    ...
    { word_en: "coffee", word_th: "กาแฟ", pronunciation: "gaa-fɛɛ", ex_en: "", ex_pronunciation: "", ex_th: "" },
...
const dictionaryBook1 = [
    ...
    { word_en: "we / us", word_th: "พวกเรา", pronunciation: "phûak-raw", ex_en: "We will not swim.", ex_pronunciation: "phûak-raw jà mâi wâay-náam", ex_th: "พวกเราจะไม่วา่ ยนํ ;า" },
    ...
    { word_en: "belong to / of", word_th: "ของ", pronunciation: "khɔ̌ɔŋ", ex_en: "My house (house belong to me)", ex_pronunciation: "bâan khɔ̌ɔŋ phǒm", ex_th: "" },
    ...
    { word_en: "to eat", word_th: "กิน", pronunciation: "gin", ex_en: "I usually eat Thai food.", ex_pronunciation: "(bpòk-gà-dtì) phǒm gin aa-hǎan thai", ex_th: "(ปกติ) ผมกินอาหารไทย" },
    { word_en: "to drink", word_th: "ดืxม", pronunciation: "dʉ̀ʉm", ex_en: "Normally, I drink coffee.", ex_pronunciation: "(bpòk-gà-dtì) phǒm dɯ̀ɯm / gin gaa-fɛɛ", ex_th: "(ปกติ) ผมดืxม/กินกาแฟ" },
    { word_en: "to watch", word_th: "ดู", pronunciation: "duu", ex_en: "Normally, I watch TV.", ex_pronunciation: "(bpòk-gà-dtì) chǎn duu thii-wii", ex_th: "(ปกติ) ฉันดูทีวี" },
    { word_en: "to listen", word_th: "ฟัง", pronunciation: "faŋ", ex_en: "I usually listen to Thai songs.", ex_pronunciation: "(bpòk-gà-dtì) chǎn faŋ phleeŋ thai", ex_th: "(ปกติ) ฉันฟั งเพลงไทย" },
    { word_en: "to wake up", word_th: "ตืxน", pronunciation: "dtɯɯn", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to lie down / sleep", word_th: "นอน", pronunciation: "nɔɔn", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to walk", word_th: "เดิน", pronunciation: "dəən", ex_en: "He/She doesn't like walking.", ex_pronunciation: "khǎw mâi chɔ̂ɔp dəən", ex_th: "เขาไม่ชอบเดิน" },
    { word_en: "to speak", word_th: "พูด", pronunciation: "phûut", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to study", word_th: "เรียน", pronunciation: "rian", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to write", word_th: "เขียน", pronunciation: "khǐan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to read", word_th: "อ่าน", pronunciation: "àan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to take a shower", word_th: "อาบนํ âา", pronunciation: "àap-náam", ex_en: "Do they like taking a shower ?", ex_pronunciation: "phûak-khǎw chɔ̂ɔp àap-náam mǎi/mái", ex_th: "พวกเขาชอบอาบนําไหม/มัย" },
    { word_en: "to play", word_th: "เล่น", pronunciation: "lên", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to exercise", word_th: "ออกกําลังกาย", pronunciation: "ɔ̀ɔk-gam-lang-gaai", ex_en: "Normally, I exercise.", ex_pronunciation: "(bpòk-gà-dtì) chǎn ɔ̀ɔk gam-laŋ-gaay", ex_th: "(ปกติ) ฉันออกกําลังกาย" },
    { word_en: "to go", word_th: "ไป", pronunciation: "bpai", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to do / make", word_th: "ทํา", pronunciation: "tham", ex_en: "What do you like to do ?", ex_pronunciation: "khun chɔ̂ɔp tham à-rai bâaŋ khá", ex_th: "คุณชอบทําอะไรบ้างคะ" },
    ...
    { word_en: "market", word_th: "ตลาด", pronunciation: "dtà-làat", ex_en: "", ex_pronunciation: "", ex_th: "" },
    ...
    { word_en: "coffee", word_th: "กาแฟ", pronunciation: "gaa-fɛɛ", ex_en: "my coffee", ex_pronunciation: "gaa-fɛɛ khɔ̌ɔŋ phǒm", ex_th: "" },
    { word_en: "language", word_th: "ภาษา", pronunciation: "phaa-sǎa", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "like", word_th: "ชอบ", pronunciation: "chɔ̂ɔp", ex_en: "", ex_pronunciation: "", ex_th: "" },
    ...
    { word_en: "to work", word_th: "ทํางาน", pronunciation: "tham ŋaan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to do homework", word_th: "ทําการบ้าน", pronunciation: "tham gaan-bânn", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to do housework", word_th: "ทํางานบ้าน", pronunciation: "tham ŋaan-bâan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to cook", word_th: "ทําอาหาร", pronunciation: "tham aa-hǎan", ex_en: "He/She can cook.", ex_pronunciation: "khǎw tham aa-hǎan dâay", ex_th: "เขาทําอาหารได้" },
    { word_en: "to drive a car", word_th: "ขับรถ", pronunciation: "khàp rót", ex_en: "I can drive a car.", ex_pronunciation: "chǎn khàp rót dâay", ex_th: "ฉันขับรถได้" },
    { word_en: "to ride a motorbike", word_th: "ขีeมอเตอร์ไซค์", pronunciation: "khìi mɔɔ-dtəə-sai", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to ride a bicycle", word_th: "ขีeจักรยาน", pronunciation: "khiì jàk-grà-yaan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to talk with freinds", word_th: "คุยกับเพืeอน", pronunciation: "khuy gàp phɯ̂an", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to study Thai", word_th: "เรียนภาษาไทย", pronunciation: "rian phaa-sǎa thai", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to return home", word_th: "กลับบ้าน", pronunciation: "glàp bâan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    ...
    { word_en: "can", word_th: "ได้", pronunciation: "dâay", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to sit", word_th: "นัง", pronunciation: "nâŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to stand", word_th: "ยืน", pronunciation: "yɯɯn", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to run", word_th: "วิง", pronunciation: "wîŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to swim", word_th: "ว่ายนํา", pronunciation: "wâay-náam", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to do the laundry", word_th: "ซักผ้า", pronunciation: "sák-phâa", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to wash the dishes", word_th: "ล้างจาน", pronunciation: "láaŋ jaan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to rest", word_th: "พักผ่อน", pronunciation: "phák-phɔ̀ɔn", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to stroll", word_th: "เดินเล่น", pronunciation: "dəən-lên", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to listen to music", word_th: "ฟังเพลง", pronunciation: "faŋ pleeŋ", ex_en: "I usually listen to Thai songs.", ex_pronunciation: "(bpòk-gà-dtì) chǎn faŋ phleeŋ thai", ex_th: "(ปกติ) ฉันฟั งเพลงไทย" },
    { word_en: "to sing", word_th: "ร้องเพลง", pronunciation: "rɔ́ɔŋ pleeŋ", ex_en: "I usually listen to Thai songs.", ex_pronunciation: "(bpòk-gà-dtì) chǎn faŋ phleeŋ thai", ex_th: "(ปกติ) ฉันฟังเพลงไทย" },
    { word_en: "will", word_th: "จะ", pronunciation: "jà", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "-ing", word_th: "กําลัง", pronunciation: "gam-laŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "-ing", word_th: "อยู่", pronunciation: "yùu", ex_en: "", ex_pronunciation: "", ex_th: "" },
...
const dictionaryPronouns = [
    ...
    { word_en: "belong to / of", word_th: "ของ", pronunciation: "khɔ̌ɔŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
...
const dictionaryPlaces = [
    ...
    { word_en: "park", word_th: "สวน", pronunciation: "sǔan", ex_en: "", ex_pronunciation: "", ex_th: "" },
    ...
    { word_en: "market", word_th: "ตลาด", pronunciation: "dta-làat", ex_en: "", ex_pronunciation: "", ex_th: "" },
    ...
    { word_en: "river", word_th: "แม่นํา", pronunciation: "mɛ̂ɛ-náam", ex_en: "", ex_pronunciation: "", ex_th: "" }
    //    { word_en: "", word_th: "", pronunciation: "", ex_en: "", ex_pronunciation: "", ex_th: "" },
];
const dictionaryPrepositions = [
    { word_en: "to be (is/am/are)", word_th: "อยู่", pronunciation: "yùu", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "where", word_th: "ที&ไหน", pronunciation: "thîi-nǎi", ex_en: "", ex_pronunciation: "", ex_th: "" },
...
const dictionaryFood = [
    ...
    { word_en: "food", word_th: "อาหาร/กับข้าว", pronunciation: "aa-hǎan/gàp-khâaw", ex_en: "", ex_pronunciation: "", ex_th: "" },
    ...
    { word_en: "to boil/boiled", word_th: "ต้ม", pronunciation: "dtôm", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to stir fry/fried", word_th: "ผัด", pronunciation: "phàt", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to deep fry/ deep fried", word_th: "ทอด", pronunciation: "thɔ̂ɔt", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to steam/steamed", word_th: "นึงf", pronunciation: "nɯ̂ŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to grill/grilled", word_th: "ปิ", pronunciation: "bpîŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
    { word_en: "to gril/grilled", word_th: "ย่าง", pronunciation: "yâaŋ", ex_en: "", ex_pronunciation: "", ex_th: "" },
